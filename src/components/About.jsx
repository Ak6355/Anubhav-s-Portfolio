    ...
    <div className='w-full flex flex-col lg:flex-row px-8 md:px-10 gap-10 lg:gap-20 lg:py-20 '>
      ...
      <div className='w-full flex flex-col'>
        ...
        <p className='text-lg text-black dark:text-gray-400 leading-10'>
          Hello there! 👋
          <br />
          I'm Anubhav Kumar, a passionate and creative Software Engineer. With a diverse skill set and a love for building innovative and user-friendly web applications, I strive to bring ideas to life through code.
          <br />
          <br />
        ...
        >
          ...
          className='flex gap-3 items-center justify-center rounded-full shadow-lg py-2 px-4 bg-[#030a1c] text-white cursor-pointer'>
            <FaUserAlt size={14} /> Anubhav
          </p>

          <p
          className='flex gap-3 items-center justify-center rounded-full shadow-lg py-2 px-4 bg-[#030a1c] text-white cursor-pointer'>
            <MdOutlineAlternateEmail size={14} /> anubhavkumar406@gmail.com
          </p>

          <a
            href='https://wa.me/qr/PYVOBXSBCIPAP1'
            className='flex gap-3 items-center justify-center rounded-full shadow-lg py-2 px-4 bg-[#030a1c] text-white cursor-pointer'
          >
            <BsWhatsapp size={14} /> +91 8544 219 211
          </a>
